...
document.querySelector<HTMLDivElement>("#app")!.innerHTML = `
  ...
  <main id="stage"></main>
  <div id="mobile"><h1>IDENT</h1><p>Hi!<br><br>Unfortunately, this user interface is a tad too demanding to work on mobile.<br><br>I promise that it's really cool - please try it on your desktop browser!<br><br>See you there, cheers!<br><br>Greg</p></div>
`;
