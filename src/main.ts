...
document.querySelector<HTMLDivElement>("#app")!.innerHTML = `
  ...
  <main id="stage"></main>
  <div id="mobile"><h1>IDENT</h1><p>Hi! Unfortunately, this user interface is a tad too demanding to work on mobile. Please see this site using your desktop browser! See you there -- cheers. Greg</p></div>
`;
